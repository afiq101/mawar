...
const form = ref({
  ...
  name: "Untitled Form",
  bannerImg:
    "https://pcbuildsonabudget.com/wp-content/uploads/2016/01/the-witcher-3-wild-hunt-banner.png",
  fields: [
    {
      title: "Untitled Form",
      description: "",
...
<template>
  <div>
    <div
      class="form-header fixed top-16 right-0 z-20 bg-white dark:bg-slate-800 px-5 py-3 shadow-md shadow-slate-200 dark:shadow-slate-900 flex justify-between items-center"
    >
      <div>
        <FormKit
          type="text"
    ...
    <rs-modal title="Add Banner Image" v-model="showModalAddBanner">

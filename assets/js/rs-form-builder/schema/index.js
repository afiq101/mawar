        ...
        validation: {
          ...
          messages: [
            ...
            },
            {
              label: "Length",
              value:
                "[[label_name]] must be between [[no_1]] and [[no_2]] characters.",
            },
            {
              label: "Between",
              value: "[[label_name]] must be between [[no_1]] and [[no_2]].",
            },
            {
              label: "Date After",
              value: "[[label_name]] must be after [[date]]",
            },
            {
              label: "Date Before",
              value: "[[label_name]] must be before [[date]]",
            },
            {
              label: "Date Between",
              value: "[[label_name]] must be between [[date_1]] and [[date_2]]",
            },
            {
              label: "Matches",
              value: "[[label_name]] is not an allowed value.",
            },
          ],
        },
      },
